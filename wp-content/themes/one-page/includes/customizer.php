...
//            'priority' => '11',
        ...
        $wp_customize->add_section('social_network_section', array(
            'title' => __('Social Site links', 'one-page'),
            'description' => __('Allows you to setup social Site links for Dzonia Theme.', 'one-page'),
            'priority' => '13',
            'panel' => ''
        ));
	}
...
You can refer the codes from links below. %s', 'one-page' ) . '<br>' . esc_attr( 'Write icon class only. e.g, for bootstrap glyphicon&nbsp;write&nbsp;"glyphicon-eye-open" & for font awesome&nbsp;write&nbsp;"fa fa-book"' ), '<a href="https://fortawesome.github.io/Font-Awesome/icons/">https://fortawesome.github.io/Font-Awesome/icons/</a>,<br/><a href="http://getbootstrap.com/components/">http://getbootstrap.com/components/</a>' ),
			...
			'inkthemes_facebook' => array(
                ...
                'label' => __('Facebook URL', 'one-page'),
                'description' => __('Enter your Facebook URL if you have one', 'one-page'),
                'type' => 'option',
                'setting_type' => 'link',
                'default' => ''
            ),
            ...
            'inkthemes_twitter' => array(
                ...
                'label' => __('Twitter URL', 'one-page'),
                'description' => __('Enter your Twitter URL if you have one', 'one-page'),
                'type' => 'option',
                'setting_type' => 'link',
                'default' => ''
            ),
            ...
            'inkthemes_google' => array(
                ...
                'label' => __('Google+ URL', 'one-page'),
                'description' => __('Enter your Google+ URL if you have one', 'one-page'),
                'type' => 'option',
                'setting_type' => 'link',
                'default' => ''
            ),
            ...
            'inkthemes_rss' => array(
                ...
                'label' => __('RSS URL', 'one-page'),
                'description' => __('Enter your RSS URL if you have one', 'one-page'),
                'type' => 'option',
                'setting_type' => 'link',
                'default' => ''
            ),
            ...
            'inkthemes_pinterest' => array(
                ...
                'label' => __('Pinterest URL', 'one-page'),
                'description' => __('Enter your Pinterest URL if you have one', 'one-page'),
                'type' => 'option',
                'setting_type' => 'link',
                'default' => ''
            ),
            ...
            'inkthemes_linked' => array(
                ...
                'label' => __('LinkedIn URL', 'one-page'),
                'description' => __('Enter your Linkedin URL if you have one', 'one-page'),
                'type' => 'option',
                'setting_type' => 'link',
                'default' => ''
            ),
            ...
            'inkthemes_instagram' => array(
                ...
                'label' => __('Instagram URL', 'one-page'),
                'description' => __('Enter your Instagram URL if you have one', 'one-page'),
                'type' => 'option',
                'setting_type' => 'link',
                'default' => ''
            ),
            ...
            'inkthemes_youtube' => array(
                ...
                'label' => __('Youtube URL', 'one-page'),
                'description' => __('Enter your Youtube URL if you have one', 'one-page'),
                'type' => 'option',
                'setting_type' => 'link',
                'default' => ''
            ),
            ...
            'inkthemes_tumblr' => array(
                ...
                'label' => __('Tumblr URL', 'one-page'),
                'description' => __('Enter your Tumblr URL if you have one', 'one-page'),
                'type' => 'option',
                'setting_type' => 'link',
                'default' => ''
            ),
            ...
            'inkthemes_flickr' => array(
                ...
                'label' => __('Flickr URL', 'one-page'),
                'description' => __('Enter your Flickr URL if you have one', 'one-page'),
                'type' => 'option',
                'setting_type' => 'link',
                'default' => ''
            )
