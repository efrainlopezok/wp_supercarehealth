...
<head>
	...
	<?php 
		...
		wp_head(); 
	?>
<meta name="p:domain_verify" content="6d56d47b62b52291a175b8b7ee799679"/>
</head>
    ...
    <div id="page_wrapper">
		...
		<!-- logo -->
				...
				<?php if ( empty( $data['head_show_search'] ) || ( !empty($data['head_show_search']) && $data['head_show_search'] == 'yes') ) { ?>
					...
					<!-- end search -->
				<?php } ?>
<div id='ico-facebook' style='position:absolute; right:120px; top:10px;'>
			<a href='https://www.facebook.com/SuperCareHealth'><img src='http://supercarehealth.com/wp-content/uploads/2014/09/FACEBOOK_mini.png' width='33px' /></a>
</div>
<div id='ico-twitter' style='position:absolute; right:80px; top:10px;'>
			<a href='https://twitter.com/SuperCareHealth'><img src='http://supercarehealth.com/wp-content/uploads/2014/11/Twitter_whiteb.png' width='33px' /></a>
</div>
<div id='ico-linkedin' style='position:absolute; right:40px; top:10px;'>
			<a href='https://www.linkedin.com/company/supercare'><img src='http://supercarehealth.com/wp-content/uploads/2014/10/linkedin.png' width='33px' /></a>
</div>
				<!-- main menu -->
